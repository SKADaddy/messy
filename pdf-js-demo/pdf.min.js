  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      if (r(4)()) {
        ...
        s.isFetchSupported() && (f = r(201).PDFFetchStream),
          i.setPDFNetworkStreamFactory(function (e) {
            return f && s.isValidFetchUrl(e.url) ? new f(e) : new d(e);
          });
      }
      (t.build = i.build),
        (t.version = i.version),
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.arraysToBytes = function (e) {
          ...
          for (var i = 0, a = new Uint8Array(r), o = 0; o < t; o++) {
            ...
            s instanceof Uint8Array ||
              (s = 'string' == typeof s ? x(s) : new Uint8Array(s));
            var u = s.byteLength;
            a.set(s, i), (i += u);
          }
          return a;
        ...
        (t.removeNullCharacters = function (e) {
          if ('string' != typeof e)
            return (
              d('The argument for removeNullCharacters must be a string.'), e
            );
          return e.replace(k, '');
        }),
      ...
      var g = (function () {
        function e(t) {
          this.constructor === e && p('Cannot initialize BaseException.'),
            (this.message = t),
      ...
      var m = (function (e) {
        function t(e, r) {
          var n;
          return o(this, t), ((n = s(this, u(t).call(this, e))).code = r), n;
        }
        return c(t, e), t;
      })(g);
      ...
      var y = (function (e) {
        function t(e, r) {
          var n;
          return o(this, t), ((n = s(this, u(t).call(this, e))).details = r), n;
        }
        return c(t, e), t;
      })(g);
      ...
      var A = (function (e) {
        function t(e, r) {
          var n;
          return o(this, t), ((n = s(this, u(t).call(this, e))).status = r), n;
        }
        return c(t, e), t;
      })(g);
            ...
            (n = [
              {
                ...
                value: function (e, t, r) {
                  return (P[1] = e), (P[3] = t), (P[5] = r), P.join('');
                },
              },
              {
                key: 'transform',
      ...
      var E,
        O =
          ...
          function (e, t) {
            ...
            for (
              var i = 'data:'.concat(t, ';base64,'), a = 0, o = e.length;
              a < o;
              a += 3
            ) {
              var s = 255 & e[a],
      ...
      e.exports = function (e, t) {
        ...
        if ((r = v ? n : g ? n[p] || s(p, {}) : (n[p] || {}).prototype))
          for (l in t) {
            if (
              ((f = t[l]),
              (h = e.noTargetGet ? (d = i(r, l)) && d.value : r[l]),
              !c(v ? l : p + (g ? '.' : '#') + l, e.forced) && void 0 !== h)
            ) {
              if (typeof f == typeof h) continue;
              u(f, h);
            }
            (e.sham || (h && h.sham)) && a(f, 'sham', !0), o(r, l, f, e);
          }
      };
    },
    function (e, t) {
        ...
        if (
          (T &&
            ...
            p !== Object.prototype &&
              ...
              (h ||
                a(_) === p ||
                (o ? o(_, p) : 'function' != typeof _[g] && u(_, g, m)),
              s(_, k, !0, !0),
              h && (f[k] = m))),
          'values' == d &&
            P &&
      ...
      var n,
          ...
          if (!t.notified) {
            ...
            k(function () {
              for (var i = t.value, a = 1 == t.state, o = 0; n.length > o; ) {
                ...
                try {
                  h
                    ? (a || (2 === t.rejection && te(e, t), (t.rejection = 1)),
                      !0 === h
                        ? (s = i)
                        : (p && p.enter(),
                          (s = h(i)),
        ...
        ie = function (e, t, r, n) {
          if (!t.done) {
            (t.done = !0), n && (t = n);
            try {
              if (e === r) throw D("Promise can't be resolved itself");
              var i = K(r);
              i
                ? k(function () {
                    var n = { done: !1 };
    ...
    function (e, t, r) {
      ...
      var n,
        ...
        D = function (e) {
          ...
          for (r = [], n = 0; n < t; n++) {
            ...
            if (
              ...
              i.length > 1 &&
                '0' == i.charAt(0) &&
                ((a = T.test(i) ? 16 : 8), (i = i.slice(8 == a ? 1 : 2))),
              '' === i)
            )
              o = 0;
            else {
              if (!(10 == a ? O : 8 == a ? E : L).test(i)) return e;
              o = parseInt(i, a);
            }
            r.push(o);
          }
        ...
        Z = function (e) {
          var t = e.path,
            r = t.length;
          !r || ('file' == e.scheme && 1 == r && K(t[0], !0)) || t.pop();
        },
        $ = function (e) {
          ...
          for (
            ...
            switch (((o = a[f]), l)) {
              ...
              case oe:
                ...
                break;
              case se:
                if (((l = ue), '/' != o || '/' != p.charAt(f + 1))) continue;
                f++;
                break;
              case ue:
                if ('/' != o && '\\' != o) {
                ...
                if (!R.test(o)) {
                  if (
                    ...
                    if ('' != p) {
                      ...
                      (e.port = Y(e) && A === X[e.scheme] ? null : A), (p = '');
                    }
                    if (r) return;
                    l = ge;
                    continue;
              ...
              case de:
                if (((e.scheme = 'file'), '/' == o || '\\' == o)) l = pe;
                  ...
                  if (o == n)
                    ...
                    if ('#' != o) {
                      J(a.slice(f).join('')) ||
                        ((e.host = i.host), (e.path = i.path.slice()), Z(e)),
                        (l = me);
                      continue;
                    }
                    (e.host = i.host),
        ...
        (a &&
          u(we, {
            ...
            username: Me(Pe, function (e) {
              ...
              if (!Q(t)) {
                t.username = '';
                for (var n = 0; n < r.length; n++) t.username += H(r[n], G);
              }
            }),
            password: Me(Re, function (e) {
              ...
              if (!Q(t)) {
                t.password = '';
                for (var n = 0; n < r.length; n++) t.password += H(r[n], G);
              }
            }),
            ...
            port: Me(Oe, function (e) {
              var t = w(this);
              Q(t) || ('' == (e = String(e)) ? (t.port = null) : Ae(t, e, fe));
            }),
            pathname: Me(Le, function (e) {
              var t = w(this);
              t.cannotBeABaseURL || ((t.path = []), Ae(t, e + '', ge));
            }),
    ...
    function (e, t, r) {
      ...
      var n = /[^\0-\u007E]/,
        ...
        c = function (e, t, r) {
          var n = 0;
          for (e = r ? o(e / 700) : e >> 1, e += o(e / t); e > 455; n += 36)
            e = o(e / 35);
        ...
        l = function (e) {
          ...
          for (d && n.push('-'); p < i; ) {
            ...
            var g = p + 1;
            if (v - l > o((2147483647 - h) / g)) throw RangeError(a);
            for (h += (v - l) * g, l = v, t = 0; t < e.length; t++) {
              if ((r = e[t]) < l && ++h > 2147483647) throw RangeError(a);
              if (r == l) {
                ...
                n.push(s(u(m))), (f = c(h, g, p == d)), (h = 0), ++p;
              }
            }
            ++h, ++l;
          }
    ...
    function (e, t, r) {
      ...
      o(
        ...
        a(
          ...
          'toString',
          function () {
            for (var e, t = b(this).entries, r = [], n = 0; n < t.length; )
          ...
          getConstructor: function (e, t, r, c) {
            var h = e(function (e, n) {
              ...
              v = function (e, t, r) {
                var n = p(e),
                  o = i(a(t), !0);
                return !0 === o ? m(n).set(t, r) : (o[n.id] = r), e;
              };
            return (
              n(h.prototype, {
                delete: function (e) {
    ...
    function (e, t, r) {
      ...
      var n = r(7),
        ...
        se = function (e) {
          ...
          return (
            !(this === W && c(Q, t) && !c(K, t)) &&
            (!(r || !c(this, t) || !c(Q, t) || (c(this, N) && this[N][t])) || r)
          );
        },
        ue = function (e, t) {
          var r = p(e),
          ...
          if (r !== W || !c(Q, n) || c(K, n)) {
            var i = H(r, n);
            return (
              !i || !c(Q, n) || (c(r, N) && r[N][n]) || (i.enumerable = !0), i
            );
          }
        },
        ce = function (e) {
      ...
      s ||
        (C(
          (B = function () {
            ...
            return o && te && re(W, t, { configurable: !0, set: r }), ne(t, e);
          }).prototype,
          'toString',
          function () {
            return U(this).tag;
        ...
        n({ global: !0, wrap: !0, forced: !s, sham: !s }, { Symbol: B }),
        M(y($), function (e) {
          F(e);
        }),
        n(
    ...
    function (e, t, r) {
      ...
      function M(e) {
        return (
          !!o(e) && !!Object.prototype.hasOwnProperty.call(e, '_readRequests')
        );
      }
      function N(e) {
      ...
      function $(e, t) {
        ...
        return (e._pendingAbortRequest._promise = i), !1 === n && te(e, t), i;
      }
      function ee(e, t) {
      ...
      function re(e) {
        ...
        if (
          ...
          if (((e._pendingAbortRequest = void 0), !0 === r._wasAlreadyErroring))
      ...
      var oe = (function () {
        function e(e) {
          ...
          var t,
            r = e._state;
          if ('writable' === r)
            !1 === ne(e) && !0 === e._backpressure ? Re(this) : Ee(this),
              ke(this);
          else if ('erroring' === r) Te(this, e._storedError), ke(this);
        ...
        return (
          ...
          Object.defineProperty(e.prototype, 'desiredSize', {
            get: function () {
              ...
              if (void 0 === this._ownerWritableStream) throw we('desiredSize');
              return (function (e) {
      ...
      function fe(e, t) {
        ...
        if (r !== e._ownerWritableStream) return Promise.reject(we('write to'));
        var a = r._state;
      ...
      var de = (function () {
        ...
        return (
          (e.prototype.error = function (e) {
            ...
            'writable' === this._controlledWritableStream._state && _e(this, e);
          }),
      ...
      function Fe(e, t, r, n, a, o) {
        ...
        return new Promise(function (h, f) {
          ...
          function b(e, t, r) {
            'errored' === e._state ? r(e._storedError) : t.catch(r).catch(B);
          }
          function A(e, r, n) {
            function i() {
              e()
            ...
            !0 !== c &&
              ((c = !0),
              'writable' === t._state && !1 === ne(t) ? y().then(i) : i());
          }
          function S(e, r) {
            !0 !== c &&
              ((c = !0),
                ...
                : (!0 === c
                    ...
                    : u._readyPromise.then(function () {
                        return N(s).then(function (e) {
                          var t = e.value;
                          return !0 === e.done || ((l = fe(u, t).catch(i)), !1);
                        });
                      })
                  ).then(r, t);
            })(!1);
      ...
      function qe(e) {
        var t = e._controlledReadableStream;
        (e._closeRequested = !0), 0 === e._queue.length && (De(e), Ct(t));
      }
      function Ue(e, t) {
          ...
          return (
            ...
            (e.prototype.enqueue = function (e) {
              ...
              e.buffer,
                (function (e, t) {
                  ...
                  else !0 === gt(r) ? (et(e, o, i, a), at(e)) : et(e, o, i, a);
                  Je(e);
                })(this, e);
            }),
            (e.prototype.error = function (e) {
            ...
            (e.prototype[P] = function () {
              ...
              if (this._queueTotalSize > 0) {
                ...
                (this._queueTotalSize -= t.byteLength), nt(this);
                var r = void 0;
                try {
            ...
            ? ((e._pulling = !0),
              e
                ...
                .then(
                  function () {
                    (e._pulling = !1),
                      !0 === e._pullAgain && ((e._pullAgain = !1), Je(e));
                  },
                  function (t) {
                    ct(e, t);
                  }
      ...
      function Ze(e, t) {
        ...
        'default' === t.readerType
          ...
          : (function (e, t, r) {
              var n = e._reader;
              n._readIntoRequests.shift()._resolve(m(t, r, n._forAuthorCode));
            })(e, n, r);
      }
      function $e(e) {
        var t = e.bytesFilled,
      ...
      function at(e) {
        for (; e._pendingPullIntos.length > 0; ) {
          ...
          !0 === tt(e, t) && (st(e), Ze(e._controlledReadableByteStream, t));
        }
      }
      function ot(e, t) {
        var r = e._pendingPullIntos.peek();
                  ...
                  0 === e.byteLength
                    ...
                    : (function (e, t) {
                        ...
                        return (function (e, t) {
                          ...
                          if (e._pendingPullIntos.length > 0)
                            return e._pendingPullIntos.push(a), pt(r);
                          if ('closed' === r._state) {
                            var o = new i(a.buffer, a.byteOffset, 0);
                            return Promise.resolve(
                              m(o, !0, r._reader._forAuthorCode)
                            );
                          }
                          if (e._queueTotalSize > 0) {
                            if (!0 === tt(e, a)) {
                              ...
                              return (
                                nt(e),
                                Promise.resolve(
                                  m(s, !1, r._reader._forAuthorCode)
                                )
                              );
                            }
                            if (!0 === e._closeRequested) {
                              ...
                              return ct(e, u), Promise.reject(u);
                            }
                          }
                  ...
                  : ((c = !0),
                    N(u)
                      .then(function (e) {
                        if (((c = !1), !0 === e.done))
                          return (
                            !1 === l && qe(i._readableStreamController),
                            void (!1 === h && qe(a._readableStreamController))
                          );
                        var t = e.value,
                          r = t,
                          n = t;
                        !1 === l && Ue(i._readableStreamController, r),
                          !1 === h && Ue(a._readableStreamController, n);
                      })
                      .catch(B),
                    Promise.resolve());
              }
          ...
          (e.prototype.getIterator = function (e) {
            ...
            return (function (e, t) {
              ...
              var r = R(e),
                n = Object.create(q);
              return (
                (n._asyncIteratorReader = r), (n._preventCancel = Boolean(t)), n
              );
            })(this, r);
          }),
          e
      ...
      function At(e, t, r, n, i) {
        ...
        return St(a), Ge(a, Object.create(Ie.prototype), e, t, r, n, i), a;
      }
      function St(e) {
        (e._state = 'readable'),
          (e._reader = void 0),
      ...
      function xt(e, t) {
        return (
          ...
          'closed' === e._state
            ...
            : (Ct(e), e._readableStreamController[C](t).then(function () {}))
        );
      }
      function Ct(e) {
        e._state = 'closed';
      ...
      var Et = (function () {
        ...
        Lt = (function () {
          function e(e, t, r) {
            ...
            var s = v(n);
            if (
              (void 0 === i && (i = 1), (i = p(i)), void 0 !== e.readableType)
            )
            ...
            void 0 === o && (o = 0),
              ...
              (function (e, t, r, n, i, a) {
                ...
                (e._writable = (function (e, t, r, n, i, a) {
                  ...
                  return (
                    K(o),
                    pe(o, Object.create(de.prototype), e, t, r, n, i, a),
                    o
                  );
                })(
                  o,
                  ...
                  (e._readable = At(
                    ...
                    function () {
                      return (function (e) {
                        return Mt(e, !1), e._backpressureChangePromise;
                      })(e);
                    },
                    function (t) {
            ...
            var d = h(e, 'start', [this._transformStreamController]);
            u(d);
          }
          return (
        ...
        (t.getDocument = function (e) {
          ...
          for (var c in t)
            if ('url' !== c || 'undefined' == typeof window)
              if ('range' !== c)
                if ('worker' !== c)
                  if ('data' !== c || t[c] instanceof Uint8Array) n[c] = t[c];
                  else {
                    var f = t[c];
                    if ('string' == typeof f) n[c] = (0, i.stringToBytes)(f);
                    else if (
                      'object' !== S(f) ||
                      null === f ||
                      isNaN(f.length)
          ...
          if (((0, i.setVerbosityLevel)(n.verbosity), !u)) {
            ...
            (u = v.port ? N.fromPort(v) : new N(v)), (r._worker = u);
          }
          var g = r.docId;
          return (
            u.promise
                    ...
                    r >= 0 && w.renderTasks.splice(r, 1),
                      ...
                      e
                        ? (P.capability.reject(e),
                          t._abortOperatorList({ intentState: w, reason: e }))
                    ...
                    function (r) {
                      ...
                      r.done
                        ...
                        : t._transport.destroyed ||
                          (t._renderPageChunk(i, n), e());
                    },
                    function (e) {
                      if (((n.streamReader = null), !t._transport.destroyed)) {
                        if (n.operatorList) {
              ...
              value: function (e) {
                ...
                if (
                  ...
                  if (!s) {
                    ...
                    if (n instanceof a.RenderingCancelledException)
                  ...
                  r.streamReader.cancel(new i.AbortException(n && n.message)),
                    (r.streamReader = null),
                    ...
                    a = {
                      data: (function e(r) {
                        ...
                        r)) {
                          for (
                            var c = void 0, l = r;
                            !(c = Object.getOwnPropertyDescriptor(l, u));

                          )
                            l = Object.getPrototypeOf(l);
                          if (void 0 !== c.value)
                            if ('function' != typeof c.value) o[u] = e(c.value);
                            else if (r.hasOwnProperty && r.hasOwnProperty(u))
                              throw new Error(
                    ...
                    if ('undefined' != typeof Worker && !x && !o()) {
                      ...
                      try {
                        (0, i.isSameOrigin)(window.location.href, a) ||
                          ...
                          (t = "importScripts('" + e + "');"),
                          (a = URL.createObjectURL(new Blob([t]))));
                        var s = new Worker(a),
                        ...
                        s.addEventListener('error', l),
                          ...
                          u.on('ready', function (e) {
                            if (
                              (s.removeEventListener('error', l), r.destroyed)
                            )
                              c();
                            else
                              try {
                        ...
                        var f = function () {
                          ...
                          try {
                            ...
                            (0, i.warn)('Cannot use postMessage transfers.'),
                              (e[0] = 0),
                              u.send('test', e);
                          }
                        };
                      ...
                      e.fontLoader.clear(),
                        e._networkStream &&
                          e._networkStream.cancelAllRequests(
                            new i.AbortException('Worker was terminated.')
                          ),
                        e.messageHandler &&
                  ...
                  t.on('GetReader', function (t, r) {
                      ...
                      (r.onPull = function () {
                        e._fullReader
                          ...
                          .then(function (e) {
                            ...
                            e.done
                              ? r.close()
                              : ((0, i.assert)((0, i.isArrayBuffer)(t)),
                    ...
                    t.on('GetDoc', function (t) {
                      ...
                      (e._numPages = n.numPages),
                        r._capability.resolve(new I(n, e));
                    }),
                            ...
                            case 'Font':
                              ...
                              if ('error' in u) {
                                ...
                                (0, i.warn)(
                                  ...
                                  e.commonObjs.resolve(a, h);
                                break;
                              }
                              var f = null;
                              l.pdfBug &&
                                c.default.FontInspector &&
                                c.default.FontInspector.enabled &&
                                (f = {
                              ...
                              e.fontLoader.bind(d).then(
                                function () {
                                  e.commonObjs.resolve(a, d);
                                },
                                function (r) {
                                  t.sendWithPromise('FontFallback', {
                                    id: a,
                                  }).finally(function () {
                                    e.commonObjs.resolve(a, d);
                                  });
                        ...
                        : new Promise(function (e, t) {
                            ...
                            (r.onload = function () {
                              var t = r.width,
                                ...
                                o = t * n,
                                s = 4 * o,
                                u = new Uint8ClampedArray(o * i),
                                c = document.createElement('canvas');
                              (c.width = t), (c.height = n);
                              var l = c.getContext('2d');
                              l.drawImage(r, 0, 0);
                              var h = l.getImageData(0, 0, t, n).data;
                              if (3 === i)
                                for (var f = 0, d = 0; f < s; f += 4, d += 3)
                                  (u[d] = h[f]),
                                    (u[d + 1] = h[f + 1]),
                                    (u[d + 2] = h[f + 2]);
                              else if (1 === i)
    ...
    function (e, t, r) {
      ...
      var A = (function (e) {
        function t(e, r) {
          var n;
          return f(this, t), ((n = s(this, u(t).call(this, e))).type = r), n;
        }
        return (
          (function (e, t) {
            if ('function' != typeof t && null !== t)
          ...
          p(e, [
            ...
            },
            {
              ...
              value: function () {
                ...
                try {
                  for (
                    var h, f = this.times[Symbol.iterator]();
                    !(u = (h = f.next()).done);
                    u = !0
                  ) {
                    var d = h.value,
                      p = d.end - d.start;
                    e += ''.concat(d.name.padEnd(t), ' ').concat(p, 'ms\n');
                  }
                } catch (e) {
                  (c = !0), (l = e);
                } finally {
      ...
      var x,
        C = (function () {
          function e() {
            f(this, e), (0, a.unreachable)('Cannot initialize DummyStatTimer.');
          }
          return (
            p(e, null, [
        ...
        l = (function () {
          ...
          function r(e, t) {
            for (
              ...
              for (var d = f < o ? a : i, p = 3, v = 0; v < d; v++)
                for (var g = 0, m = 0; m < n; m++) {
                  if (!g) {
                    var y = l[c++];
                    g = 128;
                  }
                  (h[p] = y & g ? 0 : 255), (p += 4), (g >>= 1);
                }
          ...
          function v(e, t, r, n) {
            ...
            !(function (e, t, r, n, i, a, o) {
              ...
              s = 'Luminosity' === i ? p : d;
              for (
                var v = Math.min(n, Math.ceil(1048576 / r)), g = 0;
                g < n;
                g += v
              ) {
          ...
          for (var _ in ((e.prototype = {
            ...
            executeOperatorList: function (e, t, r, i) {
              ...
              for (
                ...
                if ((c = o[s]) !== n.OPS.dependency) this[c].apply(this, a[s]);
                else {
                  var v = !0,
                    g = !1,
                    m = void 0;
            ...
            stroke: function (e) {
              ...
              if (
                ...
                var i = t.mozCurrentTransform,
                  a = n.Util.singularValueDecompose2dScale(i)[0];
            ...
            paintChar: function (e, t, r, i) {
              var a,
                ...
                f = !!(c & n.TextRenderingMode.ADD_TO_PATH_FLAG),
              ...
              if (0 !== i) {
                ...
                for (S = 0; S < f; ++S) {
                  ...
                  if ((0, n.isNum)(k)) w += (p * k * i) / 1e3;
                    ...
                    if (r.remeasure && M > 0) {
                      var N = ((1e3 * o.measureText(I).width) / i) * s;
                      if (M < N && this.isFontSubpixelAAEnabled) {
                        var D = M / N;
                        (L = !0), o.save(), o.scale(D, 1), (x /= D);
                      } else M !== N && (x += (((M - N) / 2e3) * i) / s);
                    }
                      ...
                      (m && !j
                        ...
                        : (this.paintChar(I, x, C, a),
                          j &&
                            ((P = x + j.offset.x / s),
                            (R = C - j.offset.y / s),
                            this.paintChar(j.fontChar, P, R, a)))),
                      (w += M * g + F * l),
                      L && o.restore();
                  }
                }
                d ? (t.y -= w * h) : (t.x += w * h), o.restore();
              }
            },
                  ...
                  if (((r = e[t]), (0, n.isNum)(r)))
                    ...
                    if (y)
                      (this.processingType3 = r),
                        ...
                        this.restore(),
                        (i = n.Util.applyTransform([r.width, 0], v)[0] * c + m),
                        o.translate(i, 0),
                        (s.x += i * p);
                    else
                      (0, n.warn)(
            ...
            paintImageMaskXObject: function (e) {
              ...
              if (
                ...
                c.save(),
                  ...
                  (c.fillStyle = o ? a.getPattern(c, this) : a),
                  c.fillRect(0, 0, n, i),
                  c.restore(),
            ...
            paintImageXObjectRepeat: function (e, t, r, i) {
              ...
              if (a) {
                for (
                  var o = a.width, s = a.height, u = [], c = 0, l = i.length;
                  c < l;
                  c += 2
                )
                  u.push({
            ...
            paintInlineImageXObject: function (e) {
              ...
              for (
                ...
                var y = v,
                  b = g;
                l > 2 && v > 1 && (l /= v / (y = Math.ceil(v / 2))),
                  d > 2 && g > 1 && (d /= g / (b = Math.ceil(g / 2))),
                  (p = (o = this.cachedCanvases.getCanvas(m, y, b))
        ...
        fromIR: function (e) {
          ...
          return {
            ...
            getPattern: function (e) {
              ...
              a(e, r),
                'axial' === t
                  ? (c = e.createLinearGradient(i[0], i[1], o[0], o[1]))
                  : 'radial' === t &&
                    (c = e.createRadialGradient(i[0], i[1], s, o[0], o[1], u));
        ...
        return function (e, r, n, i, a, o, s, u) {
          ...
          if (u.isEnabled)
            (c = u.drawFigures({
              ...
              (l = s.getCanvas('mesh', S, w, !1)).context.drawImage(c, 2, 2),
              (c = l.canvas);
          else {
        ...
        fromIR: function (e) {
          ...
          return {
            ...
            getPattern: function (e, h, f) {
              var d;
              if ((a(e, c), f))
                d = n.Util.singularValueDecompose2dScale(e.mozCurrentTransform);
              else if (
                ((d = n.Util.singularValueDecompose2dScale(h.baseTransform)), u)
              ) {
          ...
          (r.prototype = {
            createPatternCanvas: function (e) {
              ...
              var l = r[0],
                ...
                g = [p[0] * v[0], p[1] * v[1]],
                m = this.getSizeAndScale(i, this.ctx.canvas.width, g[0]),
                y = this.getSizeAndScale(a, this.ctx.canvas.height, g[1]),
        ...
        (this._onComObjOnMessage = function (e) {
          ...
          if (t.targetName === n.sourceName)
            if (t.stream) n._processStreamMessage(t);
              ...
              var s = i[o];
              delete i[o],
                'reason' in t ? s.reject(d(t.reason)) : s.resolve(t.data);
            } else {
              if (!(t.action in a))
                throw new Error(
              ...
              } else t.streamId ? n._createStreamSink(t) : u(t.data);
            }
        }),
          ...
          switch (e.stream) {
            case f:
              e.success
                ...
                : this.streamControllers[p].startCall.reject(d(e.reason));
              break;
            case h:
              e.success
                ? this.streamControllers[p].pullCall.resolve()
                : this.streamControllers[p].pullCall.reject(d(e.reason));
              break;
            case l:
              ...
              this.streamSinks[p].desiredSize <= 0 &&
                ...
                (this.streamSinks[p].desiredSize = e.desiredSize);
            ...
            case u:
              if (
                ...
                break;
              this.streamControllers[p].controller.enqueue(e.chunk);
              break;
            case s:
              if (
                ((0, n.assert)(
            ...
            case c:
              (0, n.assert)(
                ...
                this.streamControllers[p].controller.error(d(e.reason)),
                g();
              break;
            case o:
              e.success
                ? this.streamControllers[p].cancelCall.resolve()
                : this.streamControllers[p].cancelCall.reject(d(e.reason)),
                g();
              break;
            case a:
              ...
              new Promise(function (t) {
                ...
                this.streamSinks[p].sinkCapability.reject(d(e.reason)),
                ...
                value: function (e) {
                  for (var t = 0; t < e.length; ) {
                    ...
                    if ('<' === e[t]) {
                      ...
                      switch (e[++r]) {
                        case '/':
                          if ((++r, (n = e.indexOf('>', r)) < 0))
                            return void this.onError(f.UnterminatedElement);
                      ...
                      this.onText(this._resolveEntities(l));
                    }
                    t = r;
                  }
                },
    ...
    function (e, t, r) {
      ...
      var f = (function () {
          function e(t, r) {
            ...
            try {
              for (
                var s, c = this._queuedChunks[Symbol.iterator]();
                !(i = (s = c.next()).done);
                i = !0
              ) {
                var l = s.value;
        ...
        return {
          ...
          composeSMask: function (e, h, f) {
            ...
            l ||
              (function () {
                ...
                (f.gl = i),
                  ...
                  (f.positionLocation = i.getAttribLocation(h, 'a_position')),
                  (f.backdropLocation = i.getUniformLocation(h, 'u_backdrop')),
                  (f.subtypeLocation = i.getUniformLocation(h, 'u_subtype'));
                ...
                i.bindBuffer(i.ARRAY_BUFFER, g),
                  ...
                  i.vertexAttribPointer(d, 2, i.FLOAT, !1, 0, 0),
                  i.uniform1i(p, 0),
                  i.uniform1i(v, 1),
                  (l = f);
              })();
            ...
            return (
              ...
              m.bufferData(
                m.ARRAY_BUFFER,
                new Float32Array([0, 0, d, 0, 0, p, 0, p, d, 0, d, p]),
                m.STATIC_DRAW
              ),
              m.enableVertexAttribArray(v.positionLocation),
              m.vertexAttribPointer(v.positionLocation, 2, m.FLOAT, !1, 0, 0),
          ...
          drawFigures: function (e, i, u, c, l) {
            ...
            for (m = 0, y = c.length; m < y; m++)
              switch (c[m].type) {
                case 'lattice':
                  _ +=
                    ((b = (c[m].coords.length / c[m].verticesPerRow) | 0) - 1) *
            ...
            u
              ? g.clearColor(u[0] / 255, u[1] / 255, u[2] / 255, 1)
            ...
            g.bindBuffer(g.ARRAY_BUFFER, M),
              ...
              g.vertexAttribPointer(p.positionLocation, 2, g.FLOAT, !1, 0, 0);
      ...
      var o = (function () {
        ...
        function r(e, r, n) {
          ...
          if ((e._textDivs.push(o), (a = r.str), !t.test(a)))
            return (s.isWhitespace = !0), void e._textDivProperties.set(o, s);
          var u = i.Util.transform(e._viewport.transform, r.transform),
          ...
          if (
            ...
            var m,
              y,
              b = (l.vertical ? r.height : r.width) * e._viewport.scale,
              _ = d;
            0 !== c
              ? ((m = [v, g, -g, v, h, f]),
                (y = i.Util.getAxialAlignedBoundingBox([0, 0, b, _], m)))
              : (y = [h, f, h + b, f + _]),
              e._bounds.push({
                left: y[0],
                top: y[1],
          ...
          t.forEach(function (e) {
            ...
            for (o = t; o <= a; o++) {
              ...
              h === f
                ...
                : (l.push({ start: n.start, end: n.end, boundary: f }),
                  (h = f));
            }
            for (
              r[t].start < e.y1 &&
              ...
              if (void 0 === (i = (n = r[o]).boundary).x2New) {
                var d = !1;
                for (s = t - 1; !d && s >= 0 && r[s].start >= i.y1; s--)
                  d = r[s].boundary === i;
                for (s = a + 1; !d && s < r.length && r[s].end <= i.y2; s++)
                  d = r[s].boundary === i;
                for (s = 0; !d && s < l.length; s++) d = l[s].boundary === i;
                d || (i.x2New = u);
              }
            Array.prototype.splice.apply(r, [t, a - t + 1].concat(l));
          }),
          ...
          (u.prototype = {
            ...
            _processItems: function (e, t) {
              for (var n = 0, i = e.length; n < i; n++)
                this._textContentItemsStr.push(e[n].str), r(this, e[n], t);
            },
            ...
            expandTextDivs: function (e) {
              if (this._enhanceTextSelection && this._renderingDone) {
                ...
                for (
                  var t = [], r = [], n = 0, i = this._textDivs.length;
                  n < i;
                  n++
                ) {
                  ...
                  if (!s.isWhitespace)
                    if (e) {
                      (t.length = 0),
                        ...
                        s.paddingTop > 0
                          ? (r.push(''.concat(s.paddingTop, 'px')),
                            t.push('translateY('.concat(-s.paddingTop, 'px)')))
                          : r.push(0),
                        s.paddingRight > 0
                          ? r.push(''.concat(s.paddingRight / s.scale, 'px'))
                          : r.push(0),
                        s.paddingBottom > 0
                          ? r.push(''.concat(s.paddingBottom, 'px'))
                          : r.push(0),
                        s.paddingLeft > 0
                          ? (r.push(''.concat(s.paddingLeft / s.scale, 'px')),
                            t.push(
                              'translateX('.concat(
                          ...
                          : r.push(0);
                      var u = r.join(' ');
                      '0 0 0 0' !== u && (a.style.padding = u),
                        t.length && (a.style.transform = t.join(' '));
                    } else
                      (a.style.padding = null),
                        (a.style.transform = s.originalTransform);
                }
              }
            },
          }),
    ...
    function (e, t, r) {
      ...
      var v = (function () {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    var c = t.borderStyle.horizontalCornerRadius,
                      l = t.borderStyle.verticalCornerRadius;
                    if (c > 0 || l > 0) {
                      var h = ''.concat(c, 'px / ').concat(l, 'px');
        ...
        A = (function (e) {
          function t(e) {
            return (
              f(this, t), s(this, c(t).call(this, e, e.renderInteractiveForms))
            );
          }
          return (
            l(t, e),
                ...
                value: function () {
                  ...
                  return (
                    (this.container.style.transformOrigin = '-'
                      .concat(n + i, 'px -')
                      .concat(t.style.top)),
                    (this.container.style.left = ''.concat(n + i, 'px')),
                ...
                value: function () {
                  ...
                  if (c) {
                    ...
                    (l.textContent = '{{date}}, {{time}}'),
                      (l.dataset.l10nId = 'annotation_date_string'),
        ...
        O = (function (e) {
          function t(e) {
            ...
            return (
              ((r = s(this, c(t).call(this, e, n, !0))).containerClassName =
                'polylineAnnotation'),
            ...
            p(t, [
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    d.setAttribute('stroke-width', e.borderStyle.width),
        ...
        L = (function (e) {
          function t(e) {
            ...
            return (
              f(this, t),
              ((r = s(this, c(t).call(this, e))).containerClassName =
                'polygonAnnotation'),
                  ...
                  try {
                    for (
                      ...
                      b.setAttribute('points', l),
                        b.setAttribute('stroke-width', e.borderStyle.width),
                        b.setAttribute('stroke', 'transparent'),
                        b.setAttribute('fill', 'none'),
                        this._createPopup(this.container, b, e),
                        n.appendChild(b);
                    }
                  } catch (e) {
                    (a = !0), (o = e);
            ...
            p(e, null, [
              {
                ...
                value: function (e) {
                  ...
                  try {
                    for (
                      var a, o = e.annotations[Symbol.iterator]();
                      !(t = (a = o.next()).done);
                      t = !0
                    ) {
                      var s = a.value;
                      if (s) {
                        ...
                        u.isRenderable && e.div.appendChild(u.render());
                      }
                    }
                  } catch (e) {
                    (r = !0), (i = e);
      ...
      var d = function (e) {
        ...
        b = (function () {
          ...
          function l(r, n, a, s) {
            ...
            for (
              var g = new Uint8Array((1 + f) * p), m = 0, y = 0, b = 0;
              b < p;
              ++b
            )
              (g[m++] = 0), g.set(v.subarray(y, y + f), m), (y += f), (m += f);
                  ...
                  for (
                    ...
                    switch (0 | c) {
                      ...
                      case i.OPS.paintJpegXObject:
                        this.paintJpegXObject(l[0], l[1], l[2]);
                        break;
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (0 !== n) {
                  ...
                  var C = t.textMatrix;
                  0 !== t.textRise && ((C = C.slice())[5] += t.textRise),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                d.setAttributeNS(null, 'x', c),
                  ...
                  d.setAttributeNS(null, 'fill', this._makeShadingPattern(e)),
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (((this.svg = O), (this.transformMatrix = n), 2 === p)) {
                  var L = i.Util.makeCssRgb.apply(i.Util, s(t));
                ...
                try {
                  for (
                    ...
                    switch (c) {
                      ...
                      default:
                        (0, i.warn)(
                          'Unimplemented graphic state operator '.concat(c)
                        );
                    }
                  }
                } catch (e) {
        ...
        return (
          g(e, [
            ...
            },
            {
              ...
              value: function (e, t) {
                if (t <= this._progressiveDataLength) return null;
                var r = this.isFsUrl ? new T(this, e, t) : new P(this, e, t);
          ...
          function t(e, r, n) {
            ...
            return (
              ...
              'http:' === i._url.protocol
                ? (i._request = y.request(x(i._url, i._httpHeaders), l))
                : (i._request = b.request(x(i._url, i._httpHeaders), l)),
    ...
    function (e, t, r) {
      ...
      var p = (function () {
          function e(t) {
            ...
            fetch(
              u,
              f(this._headers, this._withCredentials, this._abortController)
            )
              .then(function (e) {
